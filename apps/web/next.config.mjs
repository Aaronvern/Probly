...
const nextConfig = {
  ...
  // output: 'standalone', // disabled — next start serves static files directly
  transpilePackages: [],
  env: {
    NEXT_PUBLIC_API_URL: process.env.NEXT_PUBLIC_API_URL || "https://api-production-17ab.up.railway.app",
